...
translations = {8: [0.25, 0, 0], 10: [0, 0.32, 0], 13: [0, -0.13, 0], 15: [0.15, 0, 0]}
rotations = {
    2: [0, 110, 0],
    8: [30, -35, -30],
    10: [135, 20, 0],
...
zooms = {2: 1.85, 8: 1.8, 10: 1.85, 13: 1.9, 15: 1.55}
...
if args.render:
    img_name = (
        f"{path.dirname(args.model_path).split(os.sep)[-1].split('-')[0]}-{x.name}.png"
    )
