...
fig.suptitle(f"Molecules from {dset2name[dataset_name]}", fontsize=title_size)
fig.text(0.08, 0.5, "trained on", va="center", rotation="vertical", fontsize=title_size)
...
for i, model_name in enumerate(images.keys()):
    ...
    axes[i, 0].text(
        0.5,
        0.5,
        dset2name[model_name.split("_")[0]],
        rotation=90,
        ha="center",
        va="center",
        fontsize=text_size,
